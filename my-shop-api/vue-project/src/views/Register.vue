<template>
  <div class="register-container">
    <h1>S'inscrire</h1>
    <p class="register_subtile">
      J'ai déjà un compte,<RouterLink to="/login"> Me connecter </RouterLink>
    </p>
